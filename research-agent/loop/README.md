...
- Codex works primarily inside `research-experiments/` and creates pending run manifests in `research-agent/loop/runtime/queue/pending/`.
...
The controller looks for JSON manifests in:
