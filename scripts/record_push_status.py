...
PROXY_ORDER = [
    ...
    "upstream_pr688_timed_nocompile_qttt_last1_skipsliding_exact",
    ...
    "upstream_pr674_enhattn_mixer5_exact",
...
NGRAM_LOG_NAMES = {
    ...
    "record659_conf07_hedge": "h200_artifact_ngram_record659_conf07_hedge.txt",
    "record659_conf07_hedge_smoke": "h200_artifact_ngram_record659_conf07_hedge_smoke.txt",
    "record659_conf07_hedge_eta05_smoke": "h200_artifact_ngram_record659_conf07_hedge_eta05_smoke.txt",
    "record659_conf07_hedge_eta20_smoke": "h200_artifact_ngram_record659_conf07_hedge_eta20_smoke.txt",
    ...
    "record674_hedge_smoke": "h200_artifact_ngram_record674_hedge_smoke.txt",
    ...
    "record688_mixer5": "h200_artifact_ngram_record688_mixer5.txt",
...
def proxy_log_path(log_dir: Path, arch_candidate: str, ttt_candidate: str, seed: int) -> Path:
    ...
    if arch_candidate == "upstream_pr674_timed_exact":
        return log_dir / f"h200_upstream_pr674_proxy7185_timed_seed{seed}.txt"
    if arch_candidate == "upstream_pr674_timed_nocompile_exact":
        return log_dir / f"h200_upstream_pr674_proxy7185_timed_nocompile_seed{seed}.txt"
    if arch_candidate == "upstream_pr674_hedgemix_exact":
        return log_dir / f"h200_upstream_pr674_hedgemix_proxy7185_seed{seed}.txt"
    if arch_candidate == "upstream_pr674_hedgemix_timed_nocompile_exact":
        return log_dir / f"h200_upstream_pr674_hedgemix_proxy7185_timed_nocompile_seed{seed}.txt"
    if arch_candidate == "upstream_pr674_mixer5_exact":
        return log_dir / f"h200_upstream_pr674_mixer5_proxy7185_seed{seed}.txt"
    if arch_candidate == "upstream_pr674_mixer5_timed_nocompile_exact":
        return log_dir / f"h200_upstream_pr674_mixer5_proxy7185_timed_nocompile_seed{seed}.txt"
    if arch_candidate == "upstream_pr674_enhattn_mixer5_exact":
        return log_dir / f"h200_upstream_pr674_enhattn_mixer5_proxy7185_seed{seed}.txt"
    if arch_candidate == "upstream_pr674_enhattn_mixer5_timed_nocompile_exact":
        return log_dir / f"h200_upstream_pr674_enhattn_mixer5_proxy7185_timed_nocompile_seed{seed}.txt"
    if arch_candidate == "upstream_pr674_enhattn_crownq_mixer5_exact":
    ...
    if arch_candidate == "upstream_pr688_timed_exact":
    ...
    if arch_candidate == "upstream_pr700_timed_exact":
        return log_dir / f"h200_upstream_pr700_proxy600_timed_seed{seed}.txt"
    if arch_candidate == "upstream_pr700_timed_nocompile_exact":
        return log_dir / f"h200_upstream_pr700_proxy600_timed_nocompile_seed{seed}.txt"
    if arch_candidate == "upstream_pr688_timed_nocompile_skipsliding_exact":
        return log_dir / f"h200_upstream_pr688_proxy600_timed_nocompile_skipsliding_seed{seed}.txt"
    if arch_candidate == "upstream_pr688_timed_nocompile_skipsliding_eta05_exact":
        return log_dir / f"h200_upstream_pr688_proxy600_timed_nocompile_skipsliding_eta05_seed{seed}.txt"
    if arch_candidate == "upstream_pr688_timed_nocompile_skipsliding_eta20_exact":
        return log_dir / f"h200_upstream_pr688_proxy600_timed_nocompile_skipsliding_eta20_seed{seed}.txt"
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_exact":
        return log_dir / f"h200_upstream_pr688_proxy600_timed_nocompile_qttt_seed{seed}.txt"
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_nopolyak_exact":
    ...
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_skipsliding_exact":
        return log_dir / f"h200_upstream_pr688_proxy600_timed_nocompile_qttt_light_skipsliding_seed{seed}.txt"
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_ep2_skipsliding_exact":
        return log_dir / f"h200_upstream_pr688_proxy600_timed_nocompile_qttt_light_ep2_skipsliding_seed{seed}.txt"
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_ep1_skipsliding_exact":
        return log_dir / f"h200_upstream_pr688_proxy600_timed_nocompile_qttt_light_ep1_skipsliding_seed{seed}.txt"
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_last2_skipsliding_exact":
        return log_dir / f"h200_upstream_pr688_proxy600_timed_nocompile_qttt_last2_skipsliding_seed{seed}.txt"
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_last1_skipsliding_exact":
        return log_dir / f"h200_upstream_pr688_proxy600_timed_nocompile_qttt_last1_skipsliding_seed{seed}.txt"
    ...
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_stride64_exact":
        return log_dir / f"h200_upstream_pr688_proxy600_timed_nocompile_qttt_light_stride64_seed{seed}.txt"
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_chunk256_stride64_exact":
    ...
    if arch_candidate == "upstream_pr674_crownq_timed_nocompile_exact":
        return log_dir / f"h200_upstream_pr674_crownq_proxy7185_timed_nocompile_seed{seed}.txt"
    if arch_candidate == "upstream_pr674_crownq_mixer5_exact":
        return log_dir / f"h200_upstream_pr674_crownq_mixer5_proxy7185_seed{seed}.txt"
    if arch_candidate == "upstream_pr674_crownq_mixer5_timed_nocompile_exact":
        return log_dir / f"h200_upstream_pr674_crownq_mixer5_proxy7185_timed_nocompile_seed{seed}.txt"
    if arch_candidate == "upstream_pr674_enhattn_exact":
        return log_dir / f"h200_upstream_pr674_enhattn_proxy7185_seed{seed}.txt"
    if arch_candidate == "upstream_pr674_enhattn_timed_exact":
        return log_dir / f"h200_upstream_pr674_enhattn_proxy7185_timed_seed{seed}.txt"
    if arch_candidate == "upstream_pr676_exact":
        return log_dir / f"h200_upstream_pr676_proxy7185_seed{seed}.txt"
    if arch_candidate == "upstream_pr676_timed_exact":
        return log_dir / f"h200_upstream_pr676_proxy7185_timed_seed{seed}.txt"
    ...
    if arch_candidate == "upstream_pr684_timed_exact":
        return log_dir / f"h200_upstream_pr684_proxy6555_timed_seed{seed}.txt"
    if arch_candidate == "upstream_pr684_timed_nocompile_exact":
        return log_dir / f"h200_upstream_pr684_proxy6555_timed_nocompile_seed{seed}.txt"
...
def h100_command(root_dir: Path, arch_candidate: str, ttt_candidate: str, seed: int = 1337) -> str:
    ...
    if arch_candidate == "upstream_pr674_timed_exact":
        return f"TIMED_MODE=1 SEED={seed} bash {root_dir / 'scripts/h100_upstream_pr674_exact.sh'}"
    if arch_candidate == "upstream_pr674_timed_nocompile_exact":
        return f"TIMED_MODE=1 COMPILE_ENABLED=0 SEED={seed} bash {root_dir / 'scripts/h100_upstream_pr674_exact.sh'}"
    if arch_candidate == "upstream_pr674_hedgemix_exact":
        return f"SEED={seed} bash {root_dir / 'scripts/h100_upstream_pr674_hedgemix_exact.sh'}"
    if arch_candidate == "upstream_pr674_hedgemix_timed_nocompile_exact":
        return f"TIMED_MODE=1 COMPILE_ENABLED=0 SEED={seed} bash {root_dir / 'scripts/h100_upstream_pr674_hedgemix_exact.sh'}"
    if arch_candidate == "upstream_pr674_mixer5_exact":
        return f"SEED={seed} bash {root_dir / 'scripts/h100_upstream_pr674_mixer5_exact.sh'}"
    if arch_candidate == "upstream_pr674_mixer5_timed_nocompile_exact":
        return f"TIMED_MODE=1 COMPILE_ENABLED=0 SEED={seed} bash {root_dir / 'scripts/h100_upstream_pr674_mixer5_exact.sh'}"
    if arch_candidate == "upstream_pr674_enhattn_mixer5_exact":
        return f"SEED={seed} bash {root_dir / 'scripts/h100_upstream_pr674_enhattn_mixer5_exact.sh'}"
    if arch_candidate == "upstream_pr674_enhattn_mixer5_timed_nocompile_exact":
        return f"TIMED_MODE=1 COMPILE_ENABLED=0 SEED={seed} bash {root_dir / 'scripts/h100_upstream_pr674_enhattn_mixer5_exact.sh'}"
    if arch_candidate == "upstream_pr674_enhattn_crownq_mixer5_exact":
    ...
    if arch_candidate == "upstream_pr700_timed_exact":
        return f"TIMED_MODE=1 SEED={seed} bash {root_dir / 'scripts/h100_upstream_pr700_exact.sh'}"
    if arch_candidate == "upstream_pr700_timed_nocompile_exact":
        return f"TIMED_MODE=1 COMPILE_ENABLED=0 SEED={seed} bash {root_dir / 'scripts/h100_upstream_pr700_exact.sh'}"
    if arch_candidate == "upstream_pr688_timed_nocompile_skipsliding_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 SEED={seed} "
            f"RUN_ID=h100_upstream_pr688_timed_nocompile_skipsliding_seed{seed} "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_skipsliding_exact.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_skipsliding_eta05_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 MIXER_ETA=0.05 SEED={seed} "
            f"RUN_ID=h100_upstream_pr688_timed_nocompile_skipsliding_eta05_seed{seed} "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_skipsliding_eta05_exact.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_skipsliding_eta20_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 MIXER_ETA=0.20 SEED={seed} "
            f"RUN_ID=h100_upstream_pr688_timed_nocompile_skipsliding_eta20_seed{seed} "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_skipsliding_eta20_exact.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 SEED={seed} "
            f"RUN_ID=h100_upstream_pr688_timed_nocompile_qttt_seed{seed} "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_qttt_exact.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_nopolyak_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 SEED={seed} "
            f"RUN_ID=h100_upstream_pr688_timed_nocompile_qttt_nopolyak_seed{seed} "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_qttt_nopolyak_exact.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 SEED={seed} "
    ...
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_skipsliding_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 SEED={seed} "
            f"RUN_ID=h100_upstream_pr688_timed_nocompile_qttt_light_skipsliding_seed{seed} "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_qttt_light_skipsliding_exact.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_ep2_skipsliding_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 SEED={seed} "
            f"RUN_ID=h100_upstream_pr688_timed_nocompile_qttt_light_ep2_skipsliding_seed{seed} "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_qttt_light_ep2_skipsliding_exact.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_ep1_skipsliding_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 SEED={seed} "
            f"RUN_ID=h100_upstream_pr688_timed_nocompile_qttt_light_ep1_skipsliding_seed{seed} "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_qttt_light_ep1_skipsliding_exact.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_last2_skipsliding_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 SEED={seed} "
            f"RUN_ID=h100_upstream_pr688_timed_nocompile_qttt_last2_skipsliding_seed{seed} "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_qttt_last2_skipsliding_exact.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_last1_skipsliding_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 SEED={seed} "
            f"RUN_ID=h100_upstream_pr688_timed_nocompile_qttt_last1_skipsliding_seed{seed} "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_qttt_last1_skipsliding_exact.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_chunk256_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 SEED={seed} "
    ...
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_stride64_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 SEED={seed} "
            f"RUN_ID=h100_upstream_pr688_timed_nocompile_qttt_light_stride64_seed{seed} "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_qttt_light_stride64_exact.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_chunk256_stride64_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 SEED={seed} "
            f"RUN_ID=h100_upstream_pr688_timed_nocompile_qttt_light_chunk256_stride64_seed{seed} "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_qttt_light_chunk256_stride64_exact.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_chunk256_stride64_skipsliding_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 SEED={seed} "
    ...
    if arch_candidate == "upstream_pr674_crownq_timed_nocompile_exact":
        return f"TIMED_MODE=1 COMPILE_ENABLED=0 SEED={seed} bash {root_dir / 'scripts/h100_upstream_pr674_crownq_exact.sh'}"
    if arch_candidate == "upstream_pr674_crownq_mixer5_exact":
        return f"SEED={seed} bash {root_dir / 'scripts/h100_upstream_pr674_crownq_mixer5_exact.sh'}"
    if arch_candidate == "upstream_pr674_crownq_mixer5_timed_nocompile_exact":
        return f"TIMED_MODE=1 COMPILE_ENABLED=0 SEED={seed} bash {root_dir / 'scripts/h100_upstream_pr674_crownq_mixer5_exact.sh'}"
    if arch_candidate == "upstream_pr674_enhattn_exact":
        return f"SEED={seed} bash {root_dir / 'scripts/h100_upstream_pr674_enhattn_exact.sh'}"
    if arch_candidate == "upstream_pr674_enhattn_timed_exact":
        return f"TIMED_MODE=1 SEED={seed} bash {root_dir / 'scripts/h100_upstream_pr674_enhattn_exact.sh'}"
    if arch_candidate == "upstream_pr676_exact":
        return f"SEED={seed} bash {root_dir / 'scripts/h100_upstream_pr676_exact.sh'}"
    if arch_candidate == "upstream_pr676_timed_exact":
        return f"TIMED_MODE=1 SEED={seed} bash {root_dir / 'scripts/h100_upstream_pr676_exact.sh'}"
    if arch_candidate == "upstream_pr685_powmean4_exact":
    ...
    if arch_candidate == "upstream_pr684_timed_exact":
        return f"TIMED_MODE=1 SEED={seed} bash {root_dir / 'scripts/h100_upstream_pr684_exact.sh'}"
    if arch_candidate == "upstream_pr684_timed_nocompile_exact":
        return f"TIMED_MODE=1 USE_COMPILE=0 SEED={seed} bash {root_dir / 'scripts/h100_upstream_pr684_exact.sh'}"
    return (
...
def h100_three_seed_command(root_dir: Path, arch_candidate: str, ttt_candidate: str) -> str:
    ...
    if arch_candidate == "upstream_pr674_timed_exact":
        return f"TIMED_MODE=1 bash {root_dir / 'scripts/h100_upstream_pr674_exact_3seed.sh'}"
    if arch_candidate == "upstream_pr674_timed_nocompile_exact":
        return f"TIMED_MODE=1 COMPILE_ENABLED=0 bash {root_dir / 'scripts/h100_upstream_pr674_exact_3seed.sh'}"
    if arch_candidate == "upstream_pr674_hedgemix_exact":
        return f"bash {root_dir / 'scripts/h100_upstream_pr674_hedgemix_exact_3seed.sh'}"
    if arch_candidate == "upstream_pr674_hedgemix_timed_nocompile_exact":
        return f"TIMED_MODE=1 COMPILE_ENABLED=0 bash {root_dir / 'scripts/h100_upstream_pr674_hedgemix_exact_3seed.sh'}"
    if arch_candidate == "upstream_pr674_mixer5_exact":
        return f"bash {root_dir / 'scripts/h100_upstream_pr674_mixer5_exact_3seed.sh'}"
    if arch_candidate == "upstream_pr674_mixer5_timed_nocompile_exact":
        return f"TIMED_MODE=1 COMPILE_ENABLED=0 bash {root_dir / 'scripts/h100_upstream_pr674_mixer5_exact_3seed.sh'}"
    if arch_candidate == "upstream_pr674_enhattn_mixer5_exact":
        return f"bash {root_dir / 'scripts/h100_upstream_pr674_enhattn_mixer5_exact_3seed.sh'}"
    if arch_candidate == "upstream_pr674_enhattn_mixer5_timed_nocompile_exact":
        return f"TIMED_MODE=1 COMPILE_ENABLED=0 bash {root_dir / 'scripts/h100_upstream_pr674_enhattn_mixer5_exact_3seed.sh'}"
    if arch_candidate == "upstream_pr674_enhattn_crownq_mixer5_exact":
    ...
    if arch_candidate == "upstream_pr700_timed_exact":
        return f"TIMED_MODE=1 bash {root_dir / 'scripts/h100_upstream_pr700_exact_3seed.sh'}"
    if arch_candidate == "upstream_pr700_timed_nocompile_exact":
        return f"TIMED_MODE=1 COMPILE_ENABLED=0 bash {root_dir / 'scripts/h100_upstream_pr700_exact_3seed.sh'}"
    if arch_candidate == "upstream_pr688_timed_nocompile_skipsliding_exact":
        return f"TIMED_MODE=1 COMPILE_ENABLED=0 bash {root_dir / 'scripts/h100_upstream_pr688_skipsliding_exact_3seed.sh'}"
    if arch_candidate == "upstream_pr688_timed_nocompile_skipsliding_eta05_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 MIXER_ETA=0.05 "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_skipsliding_eta05_exact_3seed.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_skipsliding_eta20_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 MIXER_ETA=0.20 "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_skipsliding_eta20_exact_3seed.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_qttt_exact_3seed.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_nopolyak_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_qttt_nopolyak_exact_3seed.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 "
    ...
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_skipsliding_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_qttt_light_skipsliding_exact_3seed.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_skipsliding_batch48_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_qttt_light_skipsliding_batch48_exact_3seed.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_skipsliding_batch64_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_qttt_light_skipsliding_batch64_exact_3seed.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_skipsliding_sgd_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_qttt_light_skipsliding_sgd_exact_3seed.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_skipsliding_sgd_nomom_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_qttt_light_skipsliding_sgd_nomom_exact_3seed.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_skipsliding_sgd_batch64_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_qttt_light_skipsliding_sgd_batch64_exact_3seed.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_skipsliding_sgd_nomom_batch64_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 "
    ...
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_ep2_skipsliding_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_qttt_light_ep2_skipsliding_exact_3seed.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_ep1_skipsliding_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_qttt_light_ep1_skipsliding_exact_3seed.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_last2_skipsliding_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_qttt_last2_skipsliding_exact_3seed.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_last1_skipsliding_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_qttt_last1_skipsliding_exact_3seed.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_chunk256_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 "
    ...
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_stride64_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_qttt_light_stride64_exact_3seed.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_chunk256_stride64_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 "
            f"bash {root_dir / 'scripts/h100_upstream_pr688_qttt_light_chunk256_stride64_exact_3seed.sh'}"
        )
    if arch_candidate == "upstream_pr688_timed_nocompile_qttt_light_chunk256_stride64_skipsliding_exact":
        return (
            f"TIMED_MODE=1 COMPILE_ENABLED=0 "
    ...
    if arch_candidate == "upstream_pr674_crownq_timed_nocompile_exact":
        return f"TIMED_MODE=1 COMPILE_ENABLED=0 bash {root_dir / 'scripts/h100_upstream_pr674_crownq_exact_3seed.sh'}"
    if arch_candidate == "upstream_pr674_crownq_mixer5_exact":
        return f"bash {root_dir / 'scripts/h100_upstream_pr674_crownq_mixer5_exact_3seed.sh'}"
    if arch_candidate == "upstream_pr674_crownq_mixer5_timed_nocompile_exact":
        return f"TIMED_MODE=1 COMPILE_ENABLED=0 bash {root_dir / 'scripts/h100_upstream_pr674_crownq_mixer5_exact_3seed.sh'}"
    if arch_candidate == "upstream_pr674_enhattn_exact":
        return f"bash {root_dir / 'scripts/h100_upstream_pr674_enhattn_exact_3seed.sh'}"
    if arch_candidate == "upstream_pr674_enhattn_timed_exact":
        return f"TIMED_MODE=1 bash {root_dir / 'scripts/h100_upstream_pr674_enhattn_exact_3seed.sh'}"
    if arch_candidate == "upstream_pr676_exact":
        return f"bash {root_dir / 'scripts/h100_upstream_pr676_exact_3seed.sh'}"
    if arch_candidate == "upstream_pr676_timed_exact":
        return f"TIMED_MODE=1 bash {root_dir / 'scripts/h100_upstream_pr676_exact_3seed.sh'}"
    if arch_candidate == "upstream_pr685_powmean4_exact":
    ...
    if arch_candidate == "upstream_pr684_timed_exact":
        return f"TIMED_MODE=1 bash {root_dir / 'scripts/h100_upstream_pr684_exact_3seed.sh'}"
    if arch_candidate == "upstream_pr684_timed_nocompile_exact":
        return f"TIMED_MODE=1 USE_COMPILE=0 bash {root_dir / 'scripts/h100_upstream_pr684_exact_3seed.sh'}"
    return (
        f"ARCH_CANDIDATE={arch_candidate} "
        f"TTT_CANDIDATE={ttt_candidate} "
