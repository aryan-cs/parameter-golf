...
TARGET_SKIP_IF_LOG_EXISTS="1" \
setsid bash "$ROOT_DIR/scripts/after_log_launch_script.sh" >/tmp/h200_after_record659_conf07_hedge_launch_upstream_pr674_hedgemix_timed_nocompile.log 2>&1 < /dev/null &
