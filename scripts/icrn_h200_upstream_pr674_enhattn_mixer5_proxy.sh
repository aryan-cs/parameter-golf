...
PATCH_RUN_DIR="${PATCH_RUN_DIR:-$ROOT_DIR/../parameter-golf-pr674-enhattn-mixer5-run}"
...
RUN_ID="${RUN_ID:-h200_upstream_pr674_enhattn_mixer5_proxy7185${run_suffix}_seed${SEED}}"
