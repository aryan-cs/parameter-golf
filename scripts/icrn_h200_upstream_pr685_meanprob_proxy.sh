...
PATCH_RUN_DIR="${PATCH_RUN_DIR:-$ROOT_DIR/../parameter-golf-pr685-meanprob-run}"
LOG_DIR="${LOG_DIR:-$ROOT_DIR/records/track_non_record_16mb/2026-03-24_H200_LeakyReLU_LegalTTT_FlashFallback/logs}"
SEED="${SEED:-1337}"
RUN_ID="${RUN_ID:-h200_upstream_pr685_meanprob_proxy7185_seed${SEED}}"
...
python "$ROOT_DIR/scripts/patch_pr685_meanprob.py" "$PATCH_RUN_DIR/train_gpt.py"
