...
RUN_ID="${RUN_ID:-h200_upstream_pr753_proxybudget_nocompile_seed${SEED}}"
...
echo "Launching PR753 H200 dev proxy with MAX_WALLCLOCK_SECONDS=${MAX_WALLCLOCK_SECONDS}" >&2
