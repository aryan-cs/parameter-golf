...
# Anchors:
# - public 8xH100 lane: ~7185 steps in 600s at ~83.4ms/step
# - local 1xH200 proxy: 7185 steps in 5,503,469ms at ~765.97ms/step
export H100_PROXY_REFERENCE_STEPS="${H100_PROXY_REFERENCE_STEPS:-7185}"
export H100_PROXY_REFERENCE_STEP_AVG_MS="${H100_PROXY_REFERENCE_STEP_AVG_MS:-83.4}"
export H200_PROXY_STEP_AVG_MS="${H200_PROXY_STEP_AVG_MS:-765.97}"
export H200_PROXY_TRAIN_LIMIT_MS="${H200_PROXY_TRAIN_LIMIT_MS:-5503469}"
export H200_PROXY_TRAIN_LIMIT_SECONDS="${H200_PROXY_TRAIN_LIMIT_SECONDS:-5504}"
export H200_PROXY_TRAIN_LIMIT_MINUTES="${H200_PROXY_TRAIN_LIMIT_MINUTES:-91.7}"
