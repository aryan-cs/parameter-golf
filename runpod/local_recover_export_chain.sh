...
ssh "${SSH_ARGS[@]}" "$REMOTE" "
  ...
  bash runpod/pod_launch_export_chain.sh \
    non_ttt_vrl_gptq \
    1337 \
    configs/runpod/non_ttt_vrl_gptq_1gpu_long_prune14.env \
    configs/runpod/non_ttt_vrl_gptq_1gpu_export_prune17.env \
    configs/runpod/non_ttt_vrl_gptq_1gpu_export_prune20.env \
    configs/runpod/non_ttt_vrl_gptq_1gpu_export_prune23.env \
    configs/runpod/non_ttt_vrl_gptq_1gpu_export_prune26.env
"
